...
import com.micheal.server.micheal_transaction.annotation.Lbtransactional;
import com.micheal.server.micheal_transaction.transactional.LbTransaction;
import com.micheal.server.micheal_transaction.transactional.LbTransactionManager;
import com.micheal.server.micheal_transaction.transactional.TransactionType;
...
public class LbTransactionAspect implements Ordered {
    ...
    @Around("@annotation(com.micheal.server.micheal_transaction.annotation.Lbtransactional)")
